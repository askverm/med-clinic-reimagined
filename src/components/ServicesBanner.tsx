  ...
  return (
    <section className="py-16 lg:py-20 bg-gray-50">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        {/* Services Grid */}
        <div ref={bannerRef} className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 opacity-0 transition-all duration-1000">
        ...
        {/* CTA Banner */}
        <div className="mt-16 lg:mt-20 bg-green-600 rounded-3xl p-8 lg:p-12 text-white text-center relative overflow-hidden">
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-white text-green-600 hover:bg-gray-100 px-8 py-4 rounded-xl font-medium">
                <Phone className="mr-2 h-5 w-5" />
                Call Emergency
              </Button>
              <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-green-600 px-8 py-4 rounded-xl font-medium">
                Download App
              </Button>
            </div>
          </div>
