        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="flex items-center mb-4">
              <span className="bg-gradient-to-r from-red-500 to-blue-500 text-white px-4 py-2 rounded-full text-sm font-semibold">
            ...
            <h1 className="text-5xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <br />
              Your Complete 
              <span className="text-blue-500"> Care Ecosystem</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Button size="lg" className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-lg px-8 py-3">
                <Phone className="mr-2 h-5 w-5" />
                Emergency Care
              </Button>
              <Button variant="outline" size="lg" className="text-lg px-8 py-3 border-blue-500 text-blue-600 hover:bg-blue-50">
                Download App
              </Button>
            </div>
